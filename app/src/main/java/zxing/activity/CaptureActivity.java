...
//        addToolbar();
        ...
        private boolean initPermission() {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                ret = PermissionChecker.checkSelfPermission(CaptureActivity.this, permissions) == PermissionChecker.PERMISSION_GRANTED;
            }
            return ret;
        }
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            System.out.println("扫描的结果是 = " + resultString);

            Toast.makeText(CaptureActivity.this, "扫码成功：" + resultString, Toast.LENGTH_SHORT).show();
